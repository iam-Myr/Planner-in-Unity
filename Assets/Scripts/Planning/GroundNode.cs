...
namespace Planning
{
    public class GroundNode
    {
        ...
        public GroundNode(WorldState state)
        {
            this.parent = null;
            this.state = state;
            this.action = null;
        ...
        public GroundNode(GroundNode parent, WorldState state, PlanAction action, Predicate goal, string l)
        {
            this.parent = parent;
            this.state = state;
            this.action = action;
        ...
        public bool isGoal(GroundNode initNode)
        {
        ...
        public bool HasSameState(GroundNode other)
        {
        ...
        public bool HasSameGoals(GroundNode other)
        {
        ...
        public GroundNode GetParent() => parent;
